...
## ÜBERSICHT
Diese Website wird von Gian betrieben. Überall auf der Webseite beziehen sich die Begriffe "wir", "uns" und "unsere/e" auf Gian. Gian bietet diese Website, einschließlich aller Informationen, Tools und Dienste, die auf dieser Website verfügbar sind, Ihnen, dem Benutzer, unter der Bedingung an, dass Sie alle hier angegebenen Bedingungen, Konditionen, Richtlinien und Hinweise akzeptieren.
...
Fragen zu den Allgemeinen Geschäftsbedingungen sind unter gian.federspiel@bluewin.ch an uns zu richten.
